...
user: "${userHandle}"
visibility: "unlisted"
location: "${safe(resolvedLocation || (tripContext.location !== "null" ? tripContext.location : null) || (!/^Trip-\d/.test(tripName) ? tripName : "")  )}"
...
`;
  ...
  console.log("─────────────────────────────────────────\n");
  return { slug, title: blogData.title, url: postUrl, quality };
}
